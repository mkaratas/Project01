...
#define LCD2X16_PIN_RS_STATE_HIGH 	HAL_GPIO_WritePin( DBRS_GPIO_Port   , DBRS_Pin  , GPIO_PIN_SET )
#define LCD2X16_PIN_RW_STATE_HIGH 	HAL_GPIO_WritePin( DBRW_GPIO_Port   , DBRW_Pin  , GPIO_PIN_SET )
#define LCD2X16_PIN_E_STATE_HIGH 		HAL_GPIO_WritePin( DBE_GPIO_Port 	  , DBE_Pin		, GPIO_PIN_SET )
...
#define LCD2X16_PIN_RS_STATE_LOW		HAL_GPIO_WritePin( DBRS_GPIO_Port   , DBRS_Pin  , GPIO_PIN_RESET )
#define LCD2X16_PIN_RW_STATE_LOW		HAL_GPIO_WritePin( DBRW_GPIO_Port   , DBRW_Pin  , GPIO_PIN_RESET )
#define LCD2X16_PIN_E_STATE_LOW			HAL_GPIO_WritePin( DBE_GPIO_Port    , DBE_Pin   , GPIO_PIN_RESET )
